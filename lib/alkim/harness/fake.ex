defmodule Alkim.Harness.Fake do
  @moduledoc """
  A demo/test harness backed by `priv/bin/alkim-fake-harness`.
  ...
  `ALKIM_ENABLE_FAKE_HARNESS=true` to enable it.
  """
  ...
  def build_command(turn) do
    ...
    delay = Application.get_env(:alkim, __MODULE__, []) |> Keyword.get(:delay, "0.4")
  ...
  defp script, do: Application.app_dir(:alkim, "priv/bin/alkim-fake-harness")
end
