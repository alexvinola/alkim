defmodule Alkim.Runtime.EventBus do
  @moduledoc """
  ...
  Messages delivered to subscribers:
    ...
    * `{:session_event, %Alkim.Runtime.Event{}}`
    * `{:harnesses, [harness]}`
    * `{:workflow_event, %Alkim.Workflow.Event{}}`
    * `:nav_changed`
  ...
  def publish_workflow(%Alkim.Workflow.Event{} = event) do
