defmodule Alkim.Runtime.SessionSupervisor do
  @moduledoc """
  `DynamicSupervisor` holding one `Alkim.Runtime.SessionServer` per session.
  ...
  alias Alkim.Runtime.SessionServer
  ...
  @impl true
  def init(_opts) do
    max = Application.get_env(:alkim, :max_sessions, :infinity)
