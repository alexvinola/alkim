defmodule Alkim.Terminals.Terminal do
  @moduledoc """
  One interactive harness session: the real CLI, on a real pseudo-terminal,
  inside a workspace.

  A terminal is not a session (`Alkim.Session`). A session is driven
  headlessly and produces structured events Alkim can reason about; a
