defmodule Khymeia.Runtime.OSProcess do
  @moduledoc """
  Starts harness processes through `priv/bin/khymeia-exec` using an Erlang
  ...
  """
  @spec open(Khymeia.Harness.launch(), String.t()) :: {:ok, port()} | {:error, term()}
  def open(%{executable: executable, args: args} = launch, cwd) do
    env =
      [{"PATH", Khymeia.Harness.Executable.search_path()}] ++
  ...
  defp wrapper, do: Application.app_dir(:khymeia, "priv/bin/khymeia-exec")
end
