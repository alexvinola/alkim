defmodule Khymeia.Terminals.Log do
  @moduledoc """
  What a terminal printed, kept on disk so a session survives Khymeia
  restarting — not just the browser closing.

  This is the one place Khymeia stores raw harness output, and it deserves
  ...
  def dir do
    Application.get_env(:khymeia, :terminal_log_dir) ||
      Khymeia.Repo.config()
