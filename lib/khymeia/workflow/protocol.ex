defmodule Khymeia.Workflow.Protocol do
  @moduledoc """
  ...
  model can produce and any harness can transport as plain text:
      ...
      <khymeia:audit>{"status": "passed" | "findings", "findings": [...]}</khymeia:audit>
  ...
  @ask_advisor ~r{<khymeia:ask-advisor(?:\s+reason="([^"]*)")?\s*>(.*?)</khymeia:ask-advisor>}s
  @ask_human ~r{<khymeia:ask-human>(.*?)</khymeia:ask-human>}s
  @audit ~r{<khymeia:audit>(.*?)</khymeia:audit>}s
